                    ...
                    <div id="carousel-main" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="media/claustro/DSC_2422.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/claustro/DSC_2503.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/claustro/DSC_2513.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/claustro/ClaustroBarrocoMAQRO.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/claustro/FuenteFrente.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/claustro/Pelicano.jpg"></img>
                            </div>
                        </div>
                        <a class="left carousel-control" href="#carousel-main" role="button" data-slide="prev">
                            <img src="media/left2.png"></img>
                        </a>
                        <a class="right carousel-control" href="#carousel-main" role="button" data-slide="next">
                            <img src="media/right2.png"></img>
                        </a>
                    </div>
                </div>
