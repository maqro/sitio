        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4" style="padding:70px 0;">
                    <div class="logo">
                        <img class="img-responsive" src="media/LogoMAQRO.png" />
                    </div>
                </div>
                    ...
                    <div id="carousel-main" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="item active">
                                <img src="media/SliderPrincipal/FuenteClaustrodeSanAgustin.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/SliderPrincipal/EvangelistaSanMarcos.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/SliderPrincipal/ClaustroAbierto.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/SliderPrincipal/SalaMuaq.jpg"></img>
                            </div>
                            <div class="item">
                                <img src="media/SliderPrincipal/ClaustroBajo.jpg"></img>
                            </div>
                        </div>
